...
if __name__ == "__main__":
    ...
    # Process dynamic content from CSVs
    ...
    for json_file, template_file, table in jobs:
        ...
        # Note: the symlink target is relative to the link location
        ensure_symlink(f"../../{table}", link_name)
    
    # Link Homebrew Kit
    ensure_symlink("../../homebrew-kit", "docs/kit-homebrew")
    
    # Link static contents
    ensure_symlink("../../contents", "docs/contents")
    
    # Link favicon if it exists in root
    if os.path.exists("../favicon.png"):
        ensure_symlink("../../favicon.png", "docs/favicon.png")
    
    # Link main README as index
    ensure_symlink("../../README.md", "docs/README.md")
